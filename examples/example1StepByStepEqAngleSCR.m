% example1StepByStepEqAngleSCR
clear all

## Description:
## Given a slope face with orientation 130/70, plot the Datlight Envelope (DLE)
## by using equations for the equal-angle projection.
##
## Reference:
...
legend boxoff 
%print example1unrotTraceAndDLEeqangle.svg
...
legend('Location', 'southoutside');
legend boxoff 
%print example1rotTraceAndDLEeqangle.svg
