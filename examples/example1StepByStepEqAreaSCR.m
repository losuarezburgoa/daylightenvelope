% example1StepByStepEqAreaSCR
clear all

## Description:
## Given a slope face with orientation 130/70, plot the Datlight Envelope (DLE)
## by using equations for the equal-area projection.
##
## Reference:
## Richards, L. R., & Atherton, D.. (1987). Ground engineers reference book. 
## In F. G. Bell (Ed.) (1st ed., pp. 12.01–12.16). London: Butterworth 
## Heinemann Inc.


# The problem will be solved first as is the dip-sirection is at the East, then
...
legend boxoff 
%print example1unrotTraceAndDLE.svg
...
%plot(xE, yE, 'k^');
%plot(xG, yG, 'kx');
%text(x+dx, y+dy, lbl, 'VerticalAlignment','middle', 'HorizontalAlignment','center');
%text(xE+dx, yE+dy, lbl, 'VerticalAlignment','middle', 'HorizontalAlignment','center');
%text(xG+dx, yG+dy, lblG, 'VerticalAlignment','middle', 'HorizontalAlignment','center');
%axis equal
%hold off
...
legend('Location', 'southoutside');
legend boxoff 
%print example1rotTraceAndDLE.svg
