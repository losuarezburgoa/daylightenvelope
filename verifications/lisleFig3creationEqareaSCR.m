...
## This figure could be used as a reference equal-area net for tracing off the
...
for ii=1:1:length(d)
    [xyDaylight, xyPlane] = daylight ('equalarea', 90, d(ii));
