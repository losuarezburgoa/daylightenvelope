...
## function created with the curve analysis refelcted in the function
## 'dip2rakeofmaxcurvature' (or specified in the article about this)
## and the use of the saltbox 'probabilistic density function' function.
...
## ommited and the function recommends a value with the function 'dip2maxpoints'.
...
## the saltbox PDF, @var{rArray}.
##
## @seealso{genrakelist0to90uniform, genrakelist0to90triangular, 
##     dip2rakeofmaxcurvature, dip2maxpoints, rndsaltbox}
## @end deftypefn

## Author: Ludger O. Suarez-Burgoa <losuarezb@unal.edu.co>
## Created: 2022-02-24

function rArray = genrakelist0to90saltbox (d, dleNpts=45, wantRecomm=false, ...
        minNumPoints=3)
    ...
    # Using the function 'rndsaltbox' which is a generator of random values (or 
    # ordered values, if the flag 'lin' is set) in the real-line. 
    # For all the cases, the shape factor is constant and equal to 'p'.
    p = 0.35;
    # Rake varies symmetrically between [0, 90] degrees.
    rArray = rndsaltbox (0, 90, c, p, n, 'lin');
endfunction
