## -*- texinfo -*- 
## @deftypefn {} {@var{xyPlane}, @var{r} =} planeeqangleeastgen (@var{d}, 
##     @var{npts})
##
## Creates the coordinates of the plane's trace related to @var{d}, for a plane 
## that is oriented Eastwards in the equal-angle spherical projection. 
