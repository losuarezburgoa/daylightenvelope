## -*- texinfo -*- 
## @deftypefn {} {@var{xyDaylight}, @var{r} =} daylighteqangleeastgen 
##     (@var{d}, @var{dleNpts}, @var{genType}, @var{wantRecomm})
##
## Creates the coordinates of the daylight-envelope related to @var{d}, for a 
## plane that is oriented Eastwards in the equal-angle spherical projection.
## 
...
##     genrakelist0to90saltbox, daylighteqareaeastgen}
## @end deftypefn

## Author: Ludger O. Suarez-Burgoa <losuarezb@unal.edu.co>
## Created: 2022-03-18

function [xyDaylight, r] = daylighteqangleeastgen (d, dleNpts=45, ...
